...
namespace FandomParser
{
    public class WikiBuildingDetailProvider
    {
        ...
        public void FetchBuildingDetails(WikiBuildingInfoList wikiBuildingInfoList)
        {
            ...
            //parse infoboxes
            getUpdatedWikiBuildingInfoList(wikiBuildingInfoList);
        }
        ...
        private void getUpdatedWikiBuildingInfoList(WikiBuildingInfoList wikiBuildingInfoList)
        {
            ...
            try
            {
                foreach (var curFile in Directory.EnumerateFiles(PathToExtractedInfoboxesFolder, $"*{FILE_ENDING_INFOBOX}", SearchOption.TopDirectoryOnly))
                {
                    ...
                    var productionInfo = getProductionInfo(fileContent);
        ...
        private static ProductionInfo getProductionInfo(string infobox)
        {
