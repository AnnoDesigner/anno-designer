...
namespace InfoboxParser.Parser
{
    internal class ParserMultipleRegions : IParserMultipleRegions
    {
        ...
        //|Title A      = Building
        private static readonly Regex regexBuildingName = new Regex(@"\|Title\s*(?<region>\w{1})\s*=\s*(?<buildingName>(\w*\s*)+([.]\w*)?)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant);
        ...
        //|Building Size A = 3x13
        private static readonly Regex regexBuildingSize = new Regex(@"\|Building Size\s*(?<region>\w{1})\s*=\s*(?<value>[0-9]*\s*(x\s*[0-9]*)?)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant);

        //|Tab A               = Old World
        private static readonly Regex regexRegionName = new Regex(@"\|Tab\s*(?<region>\w{1})\s*=\s*(?<regionName>(\w*\s*)+([.]\w*)?)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant);

        //|Building Type A     = Institution
        private static readonly Regex regexBuildingType = new Regex(@"\|Building Type\s*(?<region>\w{1})\s*=\s*(?<typeName>(\w*\s*)+([.]\w*)?)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant);

        //|Produces Amount A   = 1
        private static readonly Regex regexProducesAmount = new Regex(@"\|Produces Amount\s*(?<region>\w{1})\s*=\s*(?<value>[0-9]*([.,][0-9]*)?)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant);
        //|Produces Amount Electricity A   = 1
        private static readonly Regex regexProducesAmountElectricity = new Regex(@"\|Produces Amount Electricity\s*(?<region>\w{1})\s*=\s*(?<value>[0-9]*([.,][0-9]*)?)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant);
        //|Produces Icon A     = Bricks.png
        private static readonly Regex regexProducesIcon = new Regex(@"\|Produces Icon\s*(?<region>\w{1})\s*=\s*(?<fileName>(\w*\s*)+([.]\w*)?)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant);

        //|Input 1 Amount A = 2
        private static readonly Regex regexInputAmount = new Regex(@"\|Input\s*(?<counter>[1-9]+)\s*Amount\s*(?<region>\w{1})\s*=\s*(?<value>[0-9]*([.,][0-9]*)?)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant);
        //|Input 1 Amount Electricity A = 4
        private static readonly Regex regexInputAmountElectricity = new Regex(@"\|Input\s*(?<counter>[1-9]+)\s*Amount Electricity\s*(?<region>\w{1})\s*=\s*(?<value>[0-9]*([.,][0-9]*)?)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant);
        //|Input 1 Icon A = Potato.png
        private static readonly Regex regexInputIcon = new Regex(@"\|Input\s*(?<counter>[1-9]+)\s*Icon\s*(?<region>\w{1})\s*=\s*(?<fileName>(\w*\s*)+([.]\w*)?)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant);
        ...
        //|Timber (OW) = 12
        private static readonly Regex regexConstructionTimber = new Regex(@"\|Timber\s*(?<region>\w{1})\s*=\s*(?<value>[-+]*[0-9]*([.,][0-9]*)?)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant);
        //|Bricks (OW) = 3
        private static readonly Regex regexConstructionBricks = new Regex(@"\|Bricks\s*(?<region>\w{1})\s*=\s*(?<value>[-+]*[0-9]*([.,][0-9]*)?)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant);
        //|Steel Beams (OW) = 8
        private static readonly Regex regexConstructionSteelBeams = new Regex(@"\|Steel Beams\s*(?<region>\w{1})\s*=\s*(?<value>[-+]*[0-9]*([.,][0-9]*)?)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant);
        //|Windows (OW) = 2
        private static readonly Regex regexConstructionWindows = new Regex(@"\|Windows\s*(?<region>\w{1})\s*=\s*(?<value>[-+]*[0-9]*([.,][0-9]*)?)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant);
        //|Concrete (OW) = 15
        private static readonly Regex regexConstructionConcrete = new Regex(@"\|Concrete\s*(?<region>\w{1})\s*=\s*(?<value>[-+]*[0-9]*([.,][0-9]*)?)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant);
        //|Weapons (OW) = 20
        private static readonly Regex regexConstructionWeapons = new Regex(@"\|Weapons\s*(?<region>\w{1})\s*=\s*(?<value>[-+]*[0-9]*([.,][0-9]*)?)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant);
        //|Advanced Weapons (OW) = 25
        private static readonly Regex regexConstructionAdvancedWeapons = new Regex(@"\|Advanced Weapons\s*(?<region>\w{1})\s*=\s*(?<value>[-+]*[0-9]*([.,][0-9]*)?)", RegexOptions.Compiled | RegexOptions.IgnoreCase | RegexOptions.ExplicitCapture | RegexOptions.CultureInvariant);
                ...
                while ((curLine = reader.ReadLine()) != null)
                {
                    ...
                    if (curLine.StartsWith("|Title", StringComparison.OrdinalIgnoreCase))
                    {
                        ...
                        if (matchBuildingName.Success)
                        {
                            ...
                            result = parsedBuildingName.Trim();
                ...
                while ((curLine = reader.ReadLine()) != null)
                {
                    ...
                    if (curLine.StartsWith("|Building Type", StringComparison.OrdinalIgnoreCase))
                    {
                        ...
                        if (matchBuildingType.Success)
                        {
                            ...
                            //handle entry with no value e.g. "|Building Type A     = "
