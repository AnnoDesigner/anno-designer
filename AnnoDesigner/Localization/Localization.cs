            ...
            TranslationsRaw = new Dictionary<string, IDictionary<string, string>>()
            {
                ...
                },
                {
                    "ger", new Dictionary<string, string>() {
                        ...
                        { "VersionCheckErrorMessage" , $"Etwas ist bei der Fehlerprüfung der Version schiefgegangen{Environment.NewLine}Weitere Informationen finden Sie im Protokoll. das Bild exportieren." },
                        { "VersionCheckErrorTitle" , "Versionsprüfung fehlgeschlagen." },
                        { "EnableAutomaticUpdateCheck" , "Automatische Updateprüfung beim Start aktivieren" },
                        { "ContinueCheckingForUpdates" , $"Möchten Sie beim Start weiterhin nach einer neuen Version suchen?{Environment.NewLine}{Environment.NewLine}Diese Option kann über Werkzeuge -> Präferenzen -> Update-Einstellungen geändert werden." },
