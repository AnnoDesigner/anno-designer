            ...
            {
                {
                    "eng", new Dictionary<string, string>() {
                        ...
                        { "UpdatePrefCurrentVersion" , "Current Version" },
                        { "UpdatePrefSettings" , "Settings" },
                        { "UpdatePrefCheckPreRelease" , "Check for Pre-Releases" },
                        { "UpdatePrefUpdates" , "Updates" },
                        { "UpdatePrefDownloadPresetsAndRestart" , "Download Presets and restart Application" },
                        { "UpdatePrefNewAppUpdateAvailable" , "A new Update is available! Please check the website for release notes." },
                        { "UpdatePrefNoUpdates" , "This version is up to date." },
                        { "UpdatePrefErrorCheckingUpdates" , "Error checking for updates." },
                        { "UpdatePrefMoreInfoInLog" , "More information is found in the log." },
                        { "UpdatePrefNewPresetsUpdateAvailable" , "A new Update for the Presets is available!" },
                        { "UpdatePrefBusyCheckUpdates" , "Checking for updates ..." },
                        { "UpdatePrefBusyDownloadPresets" , "Downloading Presets ..." },
                    }
                },
                {
                    "ger", new Dictionary<string, string>() {
                        ...
                        { "UpdatePrefCurrentVersion" , "Aktuelle Version" },
                        { "UpdatePrefSettings" , "Einstellungen" },
                        { "UpdatePrefCheckPreRelease" , "Auf Vorabveröffentlichungen prüfen" },
                        { "UpdatePrefUpdates" , "Updates" },
                        { "UpdatePrefDownloadPresetsAndRestart" , "Vorlagen herunterladen und Anwendung neu starten" },
                        { "UpdatePrefNewAppUpdateAvailable" , "Ein neues Update ist verfügbar! Bitte schauen Sie auf der Website nach Versionshinweisen." },
                        { "UpdatePrefNoUpdates" , "Diese Version ist auf dem neuesten Stand." },
                        { "UpdatePrefErrorCheckingUpdates" , "Fehler beim Prüfen auf Updates." },
                        { "UpdatePrefMoreInfoInLog" , "Weitere Informationen finden Sie im Protokoll." },
                        { "UpdatePrefNewPresetsUpdateAvailable" , "Ein neues Update für die Vorlagen ist verfügbar!" },
                        { "UpdatePrefBusyCheckUpdates" , "Prüfe auf Updates ..." },
                        { "UpdatePrefBusyDownloadPresets" , "Herunterladen von Vorlagen ..." },
                    }
                },
                {
                    "fra", new Dictionary<string, string>() {
                        ...
                        { "UpdatePrefCurrentVersion" , "Version actuelle" },
                        { "UpdatePrefSettings" , "Paramètres" },
                        { "UpdatePrefCheckPreRelease" , "Vérifier les pré-livraisons" },
                        { "UpdatePrefUpdates" , "Mises à jour" },
                        { "UpdatePrefDownloadPresetsAndRestart" , "Télécharger les préréglages et relancer l'application" },
                        { "UpdatePrefNewAppUpdateAvailable" , "Une nouvelle mise à jour est disponible ! Veuillez consulter le site web pour les notes de mise à jour." },
                        { "UpdatePrefNoUpdates" , "Cette version est à jour." },
                        { "UpdatePrefErrorCheckingUpdates" , "Vérification d'erreurs pour les mises à jour." },
                        { "UpdatePrefMoreInfoInLog" , "Vous trouverez plus d'informations dans le journal de bord." },
                        { "UpdatePrefNewPresetsUpdateAvailable" , "Une nouvelle mise à jour des présélections est disponible!" },
                        { "UpdatePrefBusyCheckUpdates" , "Vérifier les mises à jour ..." },
                        { "UpdatePrefBusyDownloadPresets" , "Téléchargement des préréglages ..." },
                    }
                },
                {
                    "pol", new Dictionary<string, string>() {
                        ...
                        { "UpdatePrefCurrentVersion" , "Aktualna wersja" },
                        { "UpdatePrefSettings" , "Ustawienia" },
                        { "UpdatePrefCheckPreRelease" , "Sprawdź, czy nie występują luzy wstępne" },
                        { "UpdatePrefUpdates" , "Aktualizacje" },
                        { "UpdatePrefDownloadPresetsAndRestart" , "Pobieranie ustawień wstępnych i ponowne uruchamianie aplikacji" },
                        { "UpdatePrefNewAppUpdateAvailable" , "Nowa aktualizacja jest już dostępna! Prosimy o zapoznanie się z uwagami dotyczącymi wydania aktualizacji na stronie internetowej." },
                        { "UpdatePrefNoUpdates" , "Ta wersja jest aktualna." },
                        { "UpdatePrefErrorCheckingUpdates" , "Sprawdzanie błędów w poszukiwaniu aktualizacji." },
                        { "UpdatePrefMoreInfoInLog" , "Więcej informacji znajduje się w dzienniku." },
                        { "UpdatePrefNewPresetsUpdateAvailable" , "Dostępna jest nowa aktualizacja ustawień wstępnych!" },
                        { "UpdatePrefBusyCheckUpdates" , "Sprawdzanie aktualizacji ..." },
                        { "UpdatePrefBusyDownloadPresets" , "Pobieranie zaprogramowanych ustawień..." },
                    }
                },
                {
                    "rus", new Dictionary<string, string>() {
                        ...
                        { "UpdatePrefCurrentVersion" , "Текущая версия" },
                        { "UpdatePrefSettings" , "Настройки" },
                        { "UpdatePrefCheckPreRelease" , "Проверка на наличие предпродаж" },
                        { "UpdatePrefUpdates" , "Обновления" },
                        { "UpdatePrefDownloadPresetsAndRestart" , "Скачать Предустановки и перезапустить приложение" },
                        { "UpdatePrefNewAppUpdateAvailable" , "Доступно новое Обновление! Пожалуйста, ознакомьтесь с примечаниями к обновлению на сайте." },
                        { "UpdatePrefNoUpdates" , "Эта версия обновлена." },
                        { "UpdatePrefErrorCheckingUpdates" , "Проверка на ошибки при обновлении." },
                        { "UpdatePrefMoreInfoInLog" , "Более подробная информация находится в журнале." },
                        { "UpdatePrefNewPresetsUpdateAvailable" , "Доступно новое Обновление для пресетов!" },
                        { "UpdatePrefBusyCheckUpdates" , "Проверка обновлений ..." },
                        { "UpdatePrefBusyDownloadPresets" , "Загрузка предустановок ..." },
                    }
                },
            };
