            ...
            Translations = new Dictionary<string, Dictionary<string, string>>()
            {
                 ...
                 },
                {
                    "Polish", new Dictionary<string, string>() {
                        ...
                        { "PresetsVersion" , "Presets-wersja" },
                        { "CheckForUpdates" , "Sprawdź aktualizacje" },
                        { "GoToProjectHomepage" , "Idź do strony projektu" },
                        { "AboutAnnoDesigner" , "O Anno Designerze" },
                        { "ShowGrid" , "Pokaż siatkę" },
                        { "ShowLabels" , "Pokaż podpisy" },
                        ...
                        { "BuildingPresets" , "Presets dla budynków" },
                        { "CombinedForAnnoVersions" , "Połączone presets budynków dla" },
