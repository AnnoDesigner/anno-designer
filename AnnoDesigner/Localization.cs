            ...
            {
                {
                    "eng", new Dictionary<string, string>() {
                        ...
                        { "UpdateAvailablePresetMessage" , "An updated version of the preset file is available.\nDo you want to download it and restart the application?" }, 
                ...
                },
                {
                    "ger", new Dictionary<string, string>() {
                        ...
                        { "UpdateAvailablePresetMessage" , "Eine aktualisierte Version der Vorlagen ist verfügbar.\nMöchten Sie sie herunterladen und die Anwendung neu starten?" }, 
                ...
                },
                {
                    "fra", new Dictionary<string, string>() {
                        ...
                        { "UpdateAvailablePresetMessage" , "Une version mise à jour des préréglages est disponible.\nVoulez-vous le télécharger et redémarrer l'application?" }, 
                ...
                },
                {
                    "pol", new Dictionary<string, string>() {
                        ...
                        { "UpdateAvailablePresetMessage" , "Dostępna jest zaktualizowana wersja presetów.\nChcesz ją pobrać i zrestartować aplikację?" }, 
                ...
                },
                {
                    "rus", new Dictionary<string, string>() {
                        ...
                        { "UpdateAvailablePresetMessage" , "Доступна обновленная версия предустановок.\nВы хотите скачать его и перезапустить приложение?" }, 
