...
public class LayoutObject : IBounded
{
    ...
    public Color TransparentColor
    {
        get
        {
            ...
            {
                Color tmp = WrappedAnnoObject.Color.MediaColor;
                tmp.A = 128;
    ...
    public Rect GetIconRect(int gridSize)
    {
        ...
        {
            Rect objRect = CalculateScreenRect(gridSize);
            if (_lastScreenRectForIcon != objRect)
            {
                ...
                Size iconSize = _coordinateHelper.GridToScreen(new Size(minSize, minSize), gridSize);
    ...
    public Rect GridInfluenceRadiusRect
    {
        get
        {
            ...
            {
                Point centerPoint = _coordinateHelper.GetCenterPoint(GridRect);
