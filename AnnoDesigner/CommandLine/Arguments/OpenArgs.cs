...
public class OpenArgs : IProgramArgs
{
    public class Binder : ArgsBinderBase<OpenArgs>
    {
        ...
        public Binder(IFileSystem fileSystem)
        {
            ...
            {
                IFileInfo parsedFileinfo = parseResults.GetValueOrDefault<IFileInfo>();
        ...
        {
            IFileInfo parsedFileInfo = bindingContext.ParseResult.GetValueForArgument(argumentFilePath);
