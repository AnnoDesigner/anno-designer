...
public static class CoreConstants
{
    ...
    public static class PresetsFiles
    {
        ...
        /// </summary>
        public const string ColorPresetsFile = "Presets/colors.json";

        /// <summary>
        /// Json encoded file containing the building presets.
        /// </summary>
        public const string BuildingPresetsFile = "Presets/presets.json";

        /// <summary>
        /// Json encoded file containing the localized names for the icons.
        /// </summary>
        public const string IconNameFile = "Presets/icons.json";
        ...
        /// </summary>
        public const string TreeLocalizationFile = "Presets/treeLocalization.json";
    }
