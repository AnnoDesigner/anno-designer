...
public static class NewFactionAndGroup1800
{
    ...
    private static readonly List<string> ChangeBuildingsToOW1_Public_1800 = ["Logistic_01 (Marketplace)", "Service_01 (Pub)", "Institution_02 (Fire Department)",];
    private static readonly List<string> ChangeBuildingsToOW2_Public_1800 = ["Institution_01 (Police)", "Service_04 (Church)", "Service_02 (School)"];
    private static readonly List<string> ChangeBuildingsToOW3_Public_1800 = ["Institution_03 (Hospital)", "Service_05 (Cabaret)", "Service_07 (University)",];
    private static readonly List<string> ChangeBuildingsToOW4_Public_1800 = ["Service_03 (Bank)", "Electricity_02 (Oil Power Plant)"];
    private static readonly List<string> ChangeBuildingsToOW5_Public_1800 = ["Service_09 (Club House)"];
    private static readonly List<string> ChangeBuildingsToOW6_Public_1800 = ["ResearchCenter_01", "Service_moderate_LoL_01 (Radio Station)"];
    private static readonly List<string> ChangeBuildingsToNW1_Public_1800 = ["Institution_colony01_02 (Fire Department)", "Institution_colony01_01 (Police)", "Service_colony01_01 (Marketplace)", "Service_colony01_02 (Chapel)"];
    private static readonly List<string> ChangeBuildingsToNW2_Public_1800 = ["Institution_colony01_03 (Hospital)", "Service_colony01_03 (Boxing Arena)"];
    private static readonly List<string> ChangeBuildingsToAT1_Public_1800 = ["Service_arctic_01 (Canteen)", "Institution_arctic_01 (Ranger Station)"];
    private static readonly List<string> ChangeBuildingsToAT2_Public_1800 = ["Service_arctic_02 (Post Office)"];
    private static readonly List<string> ChangeBuildingsToAF1_Public_1800 = ["Service_colony02_01 (Bazaar)", "Service_colony02_02 (Music Plaza)", "Institution_colony02_01 (Fire Station)"];
    private static readonly List<string> ChangeBuildingsToAF2_Public_1800 = ["Institution_colony02_02 (Police)", "Institution_colony02_03 (Hospital)", "Service_colony02_03 (Monastery)"];

    // Production Buildings
    // private static readonly List<string> ChangeBuildingsToAW_Productions_1800 = new List<string> { "" }; // Example
    private static readonly List<string> ChangeBuildingsToOW1_Productions_1800 = ["Coastal_01 (Fish Coast Building)", "Processing_04 (Weavery)", "Food_06 (Schnapps Maker)", "Factory_03 (Timber Factory)", "Agriculture_05 (Timber Yard)"];
    private static readonly List<string> ChangeBuildingsToOW2_Productions_1800 = ["Factory_09 (Sailcloth Factory)", "Heavy_01 (Beams Heavy Industry)", "Heavy_04 (Weapons Heavy Industry)", "Heavy_02 (Steel Heavy Industry)", "Heavy_03 (Coal Heavy Industry)", "Processing_01 (Tallow Processing)", "Food_07 (Sausage Maker)", "Processing_02 (Flour Processing)", "Factory_02 (Soap Factory)", "Processing_03 (Malt Processing)", "Food_02 (Beer Maker)", "Factory_04 (Brick Factory)", "Food_01 (Bread Maker)"];
    private static readonly List<string> ChangeBuildingsToOW3_Productions_1800 = ["Food_03 (Goulash Factory)", "Food_05 (Canned Food Factory)", "Processing_06 (Glass Processing)", "Factory_07 (Window Factory)", "Agriculture_09 (Hunter's Cabin)", "Factory_05 (Fur Coat Workshop)", "Workshop_03 (Sewing Machines Factory)"];
    private static readonly List<string> ChangeBuildingsToOW4_Productions_1800 = ["Factory_06 (Light Bulb Factory)", "Processing_08 (Carbon Filament Processing)", "Workshop_02 (Pocket Watch Workshop)", "Workshop_05 (Gold Workshop)", "Heavy_07 (Steam Motors Heavy Industry)", "Workshop_01 (High-Wheeler Workshop)", "Heavy_06 (Advanced Weapons Heavy Industry)", "Processing_05 (Dynamite Processing)", "Coastal_02 (Niter Coast Building)", "Workshop_07 (Glasses Workshop)", "Heavy_09 (Brass Heavy Industry)", "Heavy_10 (Oil Heavy Industry)", "Factory_01 (Concrete Factory)", "Heavy_10_field (Oil Pump)", "Moderate_fuel_station_01 (FuelStation)"];
    private static readonly List<string> ChangeBuildingsToOW5_Productions_1800 = ["Heavy_08 (Steam Carriages Heavy Industry)", "Factory_10 (Chassis Factory)", "Workshop_04 (Phonographs Workshop)", "Processing_07 (Inlay Processing)", "Workshop_06 (Jewelry Workshop)", "Food_08 (Champagne Maker)"];
    private static readonly List<string> ChangeBuildingsToOW6_Productions_1800 = ["Final_moderate_LoL_01(Leather Shoes)", "Final_moderate_LoL_02 (Suits)", "Final_moderate_LoL_03 (Telephones)", "Final_moderate_LoL_01 (Leather Shoes)"];
    private static readonly List<string> ChangeBuildingsToNW1_Productions_1800 = ["Processing_colony01_02 (Poncho Maker)", "Coastal_colony01_01 (Pearls Coast Building)", "Food_colony01_04 (Fried Banana Maker)", "Coastal_colony01_02 (Fish Coast Building)", "Factory_colony01_02 (Sailcloth Factory)", "Factory_colony01_01 (Timber Factory)", "Agriculture_colony01_06 (Timber Yard)", "Factory_colony01_03 (Cotton Cloth Processing)", "Food_colony01_01 (Rum Maker)"];
    private static readonly List<string> ChangeBuildingsToNW2_Productions_1800 = ["Food_colony01_02 (Chocolate Maker)", "Workshop_colony01_01 (Cigars Workshop)", "Factory_colony01_07 (Bombin Maker)", "Factory_colony01_06 (Felt Maker)", "Food_colony01_03 (Coffee Maker)", "Food_colony01_05 (Burrito Maker)", "Processing_colony01_01 (Sugar Processing)", "Processing_colony01_03 (Inlay Processing)", "Heavy_colony01_01 (Oil Heavy Industry)", "Heavy_colony01_01_field (Oil Pump)", "Colony01_fuel_station_01 (FuelStation)", "Factory_colony01_05 (Brick Factory)"];
    private static readonly List<string> ChangeBuildingsToAT1_Productions_1800 = ["Agriculture_arctic_01 (Timber Yard)", "Factory_arctic_01 (Timber Factory)", "Agriculture_arctic_02 (Caribou Hunter)", "Factory_arctic_02 (Sleeping Bags Factory)", "Heavy_arctic_01 (Coal Heavy Industry)", "Coastal_arctic_01 (Whale Coast Building)", "Coastal_arctic_02 (Seal Hunter)", "Factory_arctic_03 (Oil Lamp Factory)", "Food_arctic_01 (Pemmican)"];
    private static readonly List<string> ChangeBuildingsToAT2_Productions_1800 = ["Agriculture_arctic_04 (Bear Hunter)", "Factory_arctic_04 (Parka Factory)", "Agriculture_arctic_06 (Normal Fur Hunter)", "Factory_arctic_05 (Sled Frame Factory)", "Factory_arctic_06 (Husky Sled Factory)", "Mining_arctic_01 (Gas Mine)", "Mining_arctic_02 (Gold Mine)", "Mining_arctic_01_pump (Gas Pump)", "Monument_arctic_01_00"];
    private static readonly List<string> ChangeBuildingsToAF1_Productions_1800 = ["Agriculture_colony02_01 (Wanza Woodcutter)", "Intermediate_colony02_01 (Linen Mill)", "Final_colony02_02 (Weaver)", "Coastal_colony02_01 (Salt Coast Building)", "Final_colony02_01 (Meat Dry-House)", "Final_colony02_03 (Tea Maker)"];
    private static readonly List<string> ChangeBuildingsToAF2_Productions_1800 = ["Final_colony02_05 (Brick Dry-House)", "Final_colony02_10 (Ceramics Workshop)", "Final_colony02_04 (Tapestry Workshop)", "Intermediate_colony02_02 (Spiced Teff Mill)", "Coastal_colony02_02 (Seafood Fisher)", "Final_colony02_06 (Stew Kitchen)", "Final_colony02_07 (Pipe Maker)", "Africa_fuel_station_01 (FuelStation)", "Intermediate_colony02_03 (Candle Maker)", "Final_colony02_09 (Lanterns Maker)", "Final_colony02_08 (Scriptures Workshop)"];
    private static readonly List<string> ChangeBuildingsToTou_Productions_1800 = ["Multifactory_Chemical_Lemonade", "Multifactory_Chemical_Shampoo", "Multifactory_Chemical_Souvenier"];
    // Farm Buildings
    //private static readonly List<string> ChangeBuildingsToAW_FarmBuilding_1800 = new List<string> { "" }; // Example
    private static readonly List<string> ChangeBuildingsToOW1_FarmBuilding_1800 = ["Agriculture_04 (Potato Farm)", "Agriculture_06 (Sheep Farm)",];
    private static readonly List<string> ChangeBuildingsToOW2_FarmBuilding_1800 = ["Agriculture_08 (Pig Farm)", "Agriculture_03 (Hop Farm)", "Agriculture_01 (Grain Farm)"];
    private static readonly List<string> ChangeBuildingsToOW3_FarmBuilding_1800 = ["Agriculture_11 (Bell Pepper Farm)", "Agriculture_02 (Cattle Farm)"];
    private static readonly List<string> ChangeBuildingsToOW5_FarmBuilding_1800 = ["Agriculture_10 (Vineyard)"];
    private static readonly List<string> ChangeBuildingsToNW1_FarmBuilding_1800 = ["Agriculture_colony01_11 (Alpaca Farm)", "Agriculture_colony01_08 (Banana Farm)", "Agriculture_colony01_03 (Cotton Farm)", "Agriculture_colony01_01 (Sugar Cane Farm)", "Agriculture_colony01_05 (Caoutchouc Farm)"];
    private static readonly List<string> ChangeBuildingsToNW2_FarmBuilding_1800 = ["Agriculture_colony01_09 (Cattle Farm)", "Agriculture_colony01_04 (Cocoa Farm)", "Agriculture_colony01_02 (Tobacco Farm)", "Agriculture_colony01_07 (Coffee Beans Farm)", "Agriculture_colony01_10 (Corn Farm)"];
    private static readonly List<string> ChangeBuildingsToAT1_FarmBuilding_1800 = ["Agriculture_arctic_03 (Goose Farm)"];
    private static readonly List<string> ChangeBuildingsToAT2_FarmBuilding_1800 = ["Agriculture_arctic_05 (Husky Farm)"];
    private static readonly List<string> ChangeBuildingsToAF1_FarmBuilding_1800 = ["Animal_colony02_01 (Goat Farm)", "Agriculture_colony02_02 (Flax Farm)", "Animal_colony02_02 (Sanga Farm)", "Agriculture_colony02_03 (Hibiscus)"];
    private static readonly List<string> ChangeBuildingsToAF2_FarmBuilding_1800 = ["Agriculture_colony02_04 (Teff Farm)", "Agriculture_colony02_05 (Indigo Farm)", "Agriculture_colony02_06 (Spice Grower)", "Agriculture_colony02_07 (Beekeeper)"];
    ...
    private static readonly List<string> ChangeBuildingsToAF2_RiverBuilding_1800 = ["River_colony02_01 (Clay Harvester)", "River_colony02_02 (Paper Mill)", "River_colony02_03 (Water Pump)"];

    // Special Buildings
    private static readonly List<string> ChangeBuildingsToAW_SpecialBuilding_1800 = ["Guild_house", "Town hall"];
