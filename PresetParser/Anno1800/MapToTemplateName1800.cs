...
{
    private static readonly List<string> ChangeTemplateNameToOrnamentalBuilding_Park_1800 =
    [
        "AfriFlowerBed_Single_Tree",
        "AfriFlowerBed_straight_noTree",
        "AfriFlowerBed_T",
        "AfriFlowerBed_Corner",
        "AfriFlowerBed_X",
        "AfriFlowerBed_End",
        "AfriPark_Bush01",
        "AfriPark_Tree02",
        "AfriPark_Grass",
        "AfriFlowerBed_Single_NoTree",
        "AfriPark_Bush02",
        "AfriFlowerBed_straight_Tree",
        "AfriPark_Tree01"
    ];
