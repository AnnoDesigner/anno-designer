...
public class BuildingBlockProvider
{
    ...
    private static readonly List<string> Anno2205_CoastalFarmFieldsList =
    [ "production chemical arctic facility module 01 tier 01", "production food arctic facility module 02 tier 01", "production food arctic facility module 01 tier 01",
    "production chemical earth facility module 01 tier 01"];
    private static readonly List<string> Anno2205_CoastalFarmBuildingsList =
    [ "production agriculture earth facility 05 t", "production chemical earth facility 01 t", "production chemical arctic facility 01", "production energy earth facility 02",
    ...
    private bool ParseBuildingBlockerForAnno1800(XmlDocument ifoDocument, IBuildingInfo building)
    {
        try
        {
            ...
            double xfNormal1 = double.Parse(node1["xf"].InnerText, NumberStyles.Any, CultureInfo.InvariantCulture);
            double zfNormal1 = double.Parse(node1["zf"].InnerText, NumberStyles.Any, CultureInfo.InvariantCulture);
            double xfNormal2 = double.Parse(node2["xf"].InnerText, NumberStyles.Any, CultureInfo.InvariantCulture);
            double zfNormal2 = double.Parse(node2["zf"].InnerText, NumberStyles.Any, CultureInfo.InvariantCulture);
            double xfNormal3 = double.Parse(node3["xf"].InnerText, NumberStyles.Any, CultureInfo.InvariantCulture);
            double zfNormal3 = double.Parse(node3["zf"].InnerText, NumberStyles.Any, CultureInfo.InvariantCulture);
            double xfNormal4 = double.Parse(node4["xf"].InnerText, NumberStyles.Any, CultureInfo.InvariantCulture);
            double zfNormal4 = double.Parse(node4["zf"].InnerText, NumberStyles.Any, CultureInfo.InvariantCulture);
    ...
    {
        string variationFilenameWithoutExtension = _fileSystem.Path.GetFileNameWithoutExtension(variationFilename);
