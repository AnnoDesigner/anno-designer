...
namespace AnnoDesigner.Tests
{
    public class ListExtensionsTests
    {
        ...
        {
            // Arrange/Act
            var result = ListExtensions.WithoutIgnoredObjects(null);
        ...
        {
            // Arrange/Act
            var result = ListExtensions.WithoutIgnoredObjects(new List<LayoutObject>());
        ...
        public void WithoutIgnoredObjects_ListHasNoIgnorableObjects_ShouldReturnSameList()
        {
            ...
            // Act
            var result = ListExtensions.WithoutIgnoredObjects(list);
